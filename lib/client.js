		...
		*/
		function BalanceWidget({ wide, t }) {
			...
			const refresh = (0, react.useCallback)(async () => {
				...
				try {
					const response = await fetch("/api/dsh-balance", {
